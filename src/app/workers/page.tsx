...
const WorkersPage = () => {
    ...
    try {
        ...
        if (editing && currentWorker) {
            await axiosInstance.put(`/workers/${currentWorker.id}`, sanitizedData);
            toast('Empleado actualizado');
        } else {
            await axiosInstance.post('/workers', sanitizedData);
                            ...
                            workers.map((worker) => (
                                ...
                                >
                                    <div className="flex justify-between items-start mb-3">
                                        ...
                                        <span
                                            className="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded">ID: {worker.id}</span>
                                    </div>

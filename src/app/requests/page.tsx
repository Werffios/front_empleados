                                ...
                                requests.map((req) => (
                                    ...
                                    >
                                        <div className="flex flex-wrap justify-between items-start mb-2">
                                            <div>
                                                <div className="flex items-center">
                                                    <span className="inline-block px-2.5 py-0.5 bg-purple-100 text-purple-800 text-xs font-semibold rounded-full mr-2">
                                                        Código: {req.codigo}
                                                    </span>
                                            ...
                                            <span className="inline-flex items-center px-2.5 py-0.5 bg-blue-50 text-blue-700 rounded-md text-xs font-medium">
